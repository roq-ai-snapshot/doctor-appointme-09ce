  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Doctor Appointment System - Your Gateway to Health. Simplifying Your Medical Appointments, Empowering Your Healthcare Journey. Experience Convenience and Control Today with Doctor Appointment System."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Doctor Appointment System - Your Gateway to Health. Simplifying Your Medical Appointments, Empowering Your Healthcare Journey. Experience Convenience and Control Today with Doctor Appointment System.`}
            </Text>
            <Box
